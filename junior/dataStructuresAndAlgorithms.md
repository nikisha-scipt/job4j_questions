## Collections Pro
read more.. [Collection lite](D:\java\job4j\project\job4j_questions\intern\CollectionLite.md#collections-light)
...
19) [Какая временная сложность алгоритмов(O-нотация) добавления, замены и удаления в каждой из коллекций?С чем связаны отличия?](#Какая-временная-сложность-алгоритмов(O-нотация)-добавления,-замены-и-удаления-в-каждой-из-коллекций?С-чем-связаны-отличия)
