...
31) [junit vs testng](#junit-vs-testng)
...
Здесь же стоит упомянуть Mockito. Она позволяет заменять реальные объекты в тестах на объекты-заглушки, которые имитируют поведение. Подробнее [здесь](https://site.mockito.org/).
...
[https://java-online.ru/junit-mockito.xhtml](https://java-online.ru/junit-mockito.xhtml)

## какие виды паттернов ты знаешь?
...
[link](https://habr.com/ru/company/otus/blog/544770/)
