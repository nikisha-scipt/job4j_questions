...
Данные не изменяются, а значит не происходит flush(), а он достаточно трудоемкий процесс и соответственно на уровне Java происходит улучшение производительности(ещё раз, при чтении данных не вызывается flush())
